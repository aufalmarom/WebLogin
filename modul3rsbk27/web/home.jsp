<%-- 
    Document   : home
    Created on : 18-Nov-2018, 16:19:33
    Author     : yahakim
--%>
...
/*background: linear-gradient(to right, #9bc5c3, #616161); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
 /*height: 400px;*/
   background: linear-gradient(to bottom left, #6699ff 0%, #ff99cc 100%)
...
<div class="container">
	...
	<ul class="nav nav-pills nav-stacked" style="">
            <li><a href="#">Home</a></li>
            <li><a href="/modul3rsbk27/login.jsp">Logout</a></li>
	</ul>
	</div>
